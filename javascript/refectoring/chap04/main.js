...
<div>
    <div>
        ...
        <input name="production" type="text" value="${province.producers[0].production}">
        <label for="profit">수익: </label>
        <input name="profit" type="text" value="${(province.price - province.producers[0].cost) * province.producers[0].production}">
    </div>
    <div>
        ...
        <label for="production">생산량: </label>
        <input name="production" type="text" value="${province.producers[1].production}">
        <label for="profit">수익: </label>
        <input name="profit" type="text" value="${(province.price - province.producers[1].cost) * province.producers[1].production}">
    </div>
    <div>
        ...
        <label for="production">생산량: </label>
        <input name="production" type="text" value="${province.producers[2].production}">
        <label for="profit">수익: </label>
        <input name="profit" type="text" value="${(province.price - province.producers[2].cost) * province.producers[2].production}">
    </div>
</div>
<p>부족분: <strong>${province.shortfall}</strong>\t총수익: <strong>${province.profit}</strong></p>
`
